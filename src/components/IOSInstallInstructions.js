        ...
        <div className="space-y-6">
            ...
            <ol className="text-left space-y-8 pl-5 list-decimal text-gray-600">
                <li className="flex flex-col space-y-3">
                    <div>
                        <p>Tap the Share button <span className="inline-block px-2 py-1 bg-gray-100 rounded">⬆️</span> in Safari</p>
                        <p className="text-sm text-gray-500 mt-1">Look for it at the bottom center (newer iOS) or top right (older iOS) of your screen</p>
                    </div>
                    <img
