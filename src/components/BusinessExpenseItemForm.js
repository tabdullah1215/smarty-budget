...
export const BusinessExpenseItemForm = ({onSave, onClose, initialItem = null, isSaving = false}) => {
    ...
    // Use the same transitions as in PaycheckBudgetItemForm
    ...
    useEffect(() => {
        const loadCategories = async () => {
            try {
                // Load business-specific categories
                const loadedCategories = await indexdbService.getBusinessCategories();
    ...
    const handleSave = async (itemData) => {
        try {
            ...
            console.error('Error saving business expense item:', error);
                            ...
                            <div className="relative w-[95%] max-w-xl p-8 bg-white rounded-lg shadow-xl">
                                ...
                                <form className="space-y-6" onSubmit={async (e) => {
                                    ...
                                    <div>
                                        ...
                                        focus:ring-opacity-50 transition-colors duration-200"
                                            disabled={isSaving}
                                            placeholder="e.g., Hotel - San Francisco trip"
                                        />
                                    </div>
                                    ...
                                    <div className="flex justify-end space-x-4 pt-6">
                                        ...
                                        >
                                            {isSaving ? (
                                                ...
                                                initialItem ? 'Update Expense' : 'Add Expense'
                                            )}
                                        </button>
                                    </div>
                                </form>
...
export default BusinessExpenseItemForm;